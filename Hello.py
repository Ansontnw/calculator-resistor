...
if connectionType == "Series":
     n = st.slider("Enter the number of resistors in series:", min_value = 1, step = 1, value = 1, max_value = 200)
     resistors = []
     for i in range(n):
     ...
     if 0 in resistors:
         ...
         st.write("Total value resistance in parallel is {:.2f} ohms.".format(total_resistance))
